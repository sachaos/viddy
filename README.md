...
```shell
wget -O viddy.tar.gz https://github.com/sachaos/viddy/releases/download/v0.2.1/viddy_0.2.1_Linux_x86_64.tar.gz && tar xvf viddy.tar.gz && mv viddy /usr/local/bin
```
